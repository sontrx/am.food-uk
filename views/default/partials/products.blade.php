				...
				<div class="card products__card" js-productId="1"> 
					...
					<div class="card-body">
					  ...
					  <div class="products__buy">
					  	<button class="btn btn-primary btn-sm products__button js-productAdd" js-image="{{$product['image']}}" js-productId="{{$product['id']}}" js-total="1" js-price="{{$product['price']}}">add recipe</button>	
					  </div>
					</div>
