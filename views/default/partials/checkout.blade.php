				...
				<div class="checkout__box ">
					...
					<div class="product js-checkoutProduct" js-productId="{{$product['id']}}">
						...
						<div class="product__bonus">
							<span class="product__control js-productAdd" js-productAdd" js-image="{{$product['image']}}" js-productId="{{$product['id']}}" js-total="{{$product['total']}}" js-price="{{$product['price']}}"><i class="fas fa-plus"></i></span>
							<span class="product__control js-checkoutProductRemove" js-productAdd" js-productId="{{$product['id']}}" ><i class="fas fa-minus"></i></span>
						</div>
