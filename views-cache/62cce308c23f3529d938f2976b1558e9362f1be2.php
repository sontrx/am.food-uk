	...
	<div class="container">
		...
		<div class="products__box">
			...
			<div class="card products__card" js-productId="1"> 
				<a href="product?id=<?php echo e($product['id']); ?>" class="products__link">
				...
				<div class="card-body">
				  ...
				  <div class="products__buy">
				  	<button class="btn btn-primary btn-sm products__button js-productAdd" js-image="<?php echo e($product['image']); ?>" js-productId="<?php echo e($product['id']); ?>" js-total="1" js-price="<?php echo e($product['price']); ?>">Add 1 recipe <i class="fas fa-plus"></i></button>	
				  </div>
				</div>
