  		...
  		<div class="product__main">
			...
			<div class="product__cart">
				...
				<div class="product__add">
					<button class="btn btn-primary btn-block btn-sm product__button js-productAdd" js-image="<?php echo e($product['image']); ?>" js-productId="<?php echo e($product['id']); ?>" js-total="1" js-price="<?php echo e($product['price']); ?>">Add recipe</button>
				</div>
			</div>
